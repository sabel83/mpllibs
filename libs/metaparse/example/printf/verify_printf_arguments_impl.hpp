#ifndef SAFE_PRINTF_VERIFY_PRINTF_ARGUMENTS_IMPL_HPP
#define SAFE_PRINTF_VERIFY_PRINTF_ARGUMENTS_IMPL_HPP
...
#include "pop_expected.hpp"
#include "verify_argument.hpp"
