...
#define MPLLIBS_STRING_MAX_LENGTH 64
...
BOOST_AUTO_TEST_CASE(test_string)
{
  ...
  // test_empty_string
  BOOST_MPL_ASSERT((equal<MPLLIBS_STRING(""), empty_string>));

  // test_string_creation
  BOOST_MPL_ASSERT((equal<MPLLIBS_STRING("Hello"), hello>));
#endif
