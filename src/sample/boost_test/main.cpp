...
// To keep gcc happy, when -Wmissing-declarations is used
boost::unit_test::test_suite* init_unit_test_suite(int, char*[]);
boost::unit_test::test_suite* build_metatest_test_suite(const std::string&);
boost::unit_test::test_suite* build_metatest_test_suite(
  const std::string&,
  const mpllibs::metatest::test_suite&
);
...
boost::unit_test::test_suite* init_unit_test_suite(int, char*[])
{
  return build_metatest_test_suite();
}
