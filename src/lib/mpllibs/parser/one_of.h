  ...
  namespace parser
  {
    ...
    template <
      BOOST_PP_ENUM_PARAMS_WITH_A_DEFAULT(
        ...
        class p,
        mpllibs::parser::unused_one_of_argument
      ),
      class mock = int
    >
    struct one_of;
    ...
    #define PARSER_ONE_OF_UNUSED_PARAM(z, n, unused) \
      BOOST_PP_COMMA_IF(n) mpllibs::parser::unused_one_of_argument
    ...
    #define PARSER_ONE_OF_CASE(z, n, unused) \
      ...
      > : \
        mpllibs::parser::one_of_##n<BOOST_PP_ENUM_PARAMS(n, p)> \
      {};
...
namespace mpllibs
{
  namespace test_mpllibs_parser_one_of
  {
    namespace
    {
