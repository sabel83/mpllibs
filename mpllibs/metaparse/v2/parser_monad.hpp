#ifndef MPLLIBS_METAPARSE_V2_PARSER_MONAD_HPP
#define MPLLIBS_METAPARSE_V2_PARSER_MONAD_HPP
...
#include <mpllibs/metaparse/v2/parser_tag.hpp>
...
namespace mpllibs
{
  namespace metamonad
  {
    ...
    {
      template <>
      struct monad<metaparse::v2::parser_tag> :
        monad_defaults<metaparse::v2::parser_tag>
      {
        struct return_
        {
          ...
          template <class T>
          struct apply : metaparse::v2::return_<T> {};
        };
          ...
          private:
            ...
            struct apply_unchecked :
              boost::mpl::apply_wrap2<
                ...
                typename metaparse::v2::get_remaining<PrevResult>::type,
                typename metaparse::v2::get_position<PrevResult>::type
              >
            {};
          public:
            ...
            struct apply :
              boost::mpl::eval_if<
                typename metaparse::v2::is_error<
        ...
        struct fail
        {
          ...
          template <class Msg>
          struct apply : metaparse::v2::fail<Msg> {};
        };
      };
    }
  }
