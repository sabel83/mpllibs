#ifndef MPLLIBS_METAPARSE_V2_IMPL_UPDATE_C_HPP
#define MPLLIBS_METAPARSE_V2_IMPL_UPDATE_C_HPP
...
#include <mpllibs/metaparse/v2/impl/split_at_c.hpp>
#include <mpllibs/metaparse/v2/impl/concat.hpp>
  ...
  namespace metaparse
  {
    namespace v2
    {
      namespace impl
      {
        ...
        BOOST_PP_REPEAT(MPLLIBS_LIMIT_STRING_SIZE, MPLLIBS_UPDATE, ~)
