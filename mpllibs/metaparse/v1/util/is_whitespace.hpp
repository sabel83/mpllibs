#ifndef MPLLIBS_METAPARSE_V1_UTIL_IS_WHITESPACE_HPP
#define MPLLIBS_METAPARSE_V1_UTIL_IS_WHITESPACE_HPP
...
#include <mpllibs/metaparse/v1/util/is_whitespace_c.hpp>
