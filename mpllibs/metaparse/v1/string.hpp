#ifndef MPLLIBS_METAPARSE_V1_STRING_HPP
#define MPLLIBS_METAPARSE_V1_STRING_HPP
...
#include <mpllibs/metaparse/v1/impl/string_iterator.hpp>
#include <mpllibs/metaparse/v1/impl/empty_string.hpp>
#include <mpllibs/metaparse/v1/impl/size.hpp>
#include <mpllibs/metaparse/v1/impl/pop_front.hpp>
...
namespace MPLLIBS_BOOST_NAMESPACE
{
  namespace mpl
  {
    ...
    template <>
    struct push_back_impl<mpllibs::metaparse::v1::string_tag>
    {
      typedef push_back_impl type;

      template <class S, class C>
      struct apply :
        mpllibs::metaparse::v1::impl::push_back_c<
          typename S::type,
          C::type::value
        >
      {};
    ...
    template <>
    struct pop_back_impl<mpllibs::metaparse::v1::string_tag>
    {
      typedef pop_back_impl type;

      template <class S>
      struct apply : mpllibs::metaparse::v1::impl::pop_back<S> {};
    };
    ...
    template <>
    struct push_front_impl<mpllibs::metaparse::v1::string_tag>
    {
      typedef push_front_impl type;

      template <class S, class C>
      struct apply :
        mpllibs::metaparse::v1::impl::push_front_c<
          typename S::type,
          C::type::value
        >
      {};
    ...
    template <>
    struct pop_front_impl<mpllibs::metaparse::v1::string_tag>
    {
      typedef pop_front_impl type;

      template <class S>
      struct apply : mpllibs::metaparse::v1::impl::pop_front<S> {};
    };
    ...
    template <>
    struct clear_impl<mpllibs::metaparse::v1::string_tag>
    {
      typedef clear_impl type;

      template <class S>
      struct apply : mpllibs::metaparse::v1::string<> {};
    };
    ...
    template <>
    struct begin_impl<mpllibs::metaparse::v1::string_tag>
    {
      typedef begin_impl type;

      template <class S>
      struct apply :
        mpllibs::metaparse::v1::impl::string_iterator<typename S::type, 0>
      {};
    };
    ...
    template <>
    struct end_impl<mpllibs::metaparse::v1::string_tag>
    {
      typedef end_impl type;

      template <class S>
      struct apply :
        mpllibs::metaparse::v1::impl::string_iterator<
          typename S::type,
          mpllibs::metaparse::v1::impl::size<typename S::type>::type::value
        >
      {};
    };
    ...
    template <>
    struct equal_to_impl<
      mpllibs::metaparse::v1::string_tag,
      mpllibs::metaparse::v1::string_tag
    >
    {
    ...
    template <class T>
    struct equal_to_impl<mpllibs::metaparse::v1::string_tag, T>
    {
      typedef equal_to_impl type;
    ...
    template <class T>
    struct equal_to_impl<T, mpllibs::metaparse::v1::string_tag> :
      equal_to_impl<mpllibs::metaparse::v1::string_tag, T>
    {};
...
#ifdef MPLLIBS_VARIADIC_STRING
    template <char... Cs>
    struct c_str<mpllibs::metaparse::v1::string<Cs...>>
    {
      typedef c_str type;
    ...
    template <>
    struct c_str<mpllibs::metaparse::v1::string<>> :
      mpllibs::metaparse::v1::impl::empty_string<>
    {};

    #if defined MPLLIBS_USE_CONSTEXPR && !defined MPLLIBS_NO_CONSTEXPR_C_STR
      template <char... Cs>
      constexpr char c_str<mpllibs::metaparse::v1::string<Cs...>>::value[];
    #else
      template <char... Cs>
      const char c_str<mpllibs::metaparse::v1::string<Cs...>>::value[]
        = {Cs...};
    #endif
...
#include <mpllibs/metaparse/v1/impl/remove_trailing_no_chars.hpp>
...
namespace mpllibs
{
  ...
  #ifdef MPLLIBS_V1_STRING_N
  #  error MPLLIBS_V1_STRING_N already defined
  #endif
  #define MPLLIBS_V1_STRING_N(z, n, s) \
    mpllibs::metaparse::v1::impl::string_at((s), n)

  #ifdef MPLLIBS_V1_STRING
  ...
  #define MPLLIBS_V1_CONFIG_NO_MPLLIBS_STRING
