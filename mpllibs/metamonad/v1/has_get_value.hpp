#ifndef MPLLIBS_METAMONAD_V1_HAS_GET_VALUE_HPP
#define MPLLIBS_METAMONAD_V1_HAS_GET_VALUE_HPP
...
#include <mpllibs/metamonad/v1/fwd/has_get_value.hpp>
  ...
  namespace metamonad
  {
    namespace v1
    {
      namespace impl
      {
        ...
        template <class T>
        yes has_get_value_test(
          T*,
          boost::mpl::int_<sizeof(T::get_value())>* = 0
        );
#else
        template <class T>
      ...
      MPLLIBS_V1_LAZY_METAFUNCTION(has_get_value, (T))
      ((
        boost::mpl::bool_<
