#ifndef MPLLIBS_METAMONAD_V1_IMPL_CURRIED_CALL_HPP
#define MPLLIBS_METAMONAD_V1_IMPL_CURRIED_CALL_HPP
  ...
  namespace metamonad
  {
    namespace v1
    {
      namespace impl
      {
        ...
        #ifdef MPLLIBS_CURRIED_CALL_SUBCASE
        #  error MPLLIBS_CURRIED_CALL_SUBCASE already defined
        #endif
        ...
        #define MPLLIBS_CURRIED_CALL_SUBCASE(z, k, n) \
          ...
          struct \
            ...
            > : \
              lambda_c< \
                BOOST_PP_ENUM_PARAMS(BOOST_PP_SUB(n, k), curry_var_) \
        ...
        #define MPLLIBS_CURRIED_CALL_CASE(z, n, unused) \
          ...
          > \
          struct BOOST_PP_CAT(curried_call, n) : \
